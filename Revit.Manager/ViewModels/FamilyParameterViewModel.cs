...
{
    public class FamilyParameterViewModel : ViewModelBase<Parameter>
    {
        public FamilyParameterViewModel(DataSet dataSet, SQLiteConnection sQLiteConnection) : base(dataSet, sQLiteConnection)
        {
